...
`;
  ...
  F${capitalize(this.getNameOfStruct(struct))}() {};`;
      ...
      `;
        ...
        var args = '';
        var assignment = ``;
        this.getParameters(struct).forEach((param) => {
            if (args.length > 0) {
                args += `, `;
            }
...
`;
    ...
    parseOneField(field, name, struct, bArray) {
        var text = "";
        var type = "";
    ...
    var c_cppHighlightRules = function() {
        ...
        this.$rules = { 
            "start" : [
                ...
                {
                    token : "support.function.C99.c", // float
                    regex : "TArray"
                },
                 {
